...
-- CreateEnum
CREATE TYPE "RecordType" AS ENUM ('LAB_RESULT', 'PRESCRIPTION', 'VISIT_SUMMARY', 'MEDICAL_HISTORY', 'OTHER');

-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('APPOINTMENT_REMINDER', 'APPOINTMENT_CONFIRMED', 'APPOINTMENT_CANCELED', 'NEW_MESSAGE', 'MEDICAL_RECORD_UPDATE', 'SYSTEM');
...
-- CreateIndex
CREATE UNIQUE INDEX "VideoSession_sessionToken_key" ON "VideoSession"("sessionToken");
