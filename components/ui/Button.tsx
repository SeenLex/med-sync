...
interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: "primary" | "primary1" | "secondary" | "outline" | "outline1" | "danger";
  size?: "sm" | "md" | "lg";
  fullWidth?: boolean;
}
...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    primary1: "bg-emerald-600 text-white hover:bg-emerald-700",
    ...
    outline1: "border border-emerald-600 text-emerald-600 hover:bg-emerald-50",
