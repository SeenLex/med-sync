      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/appointments">
                  <span className="text-emerald-100 hover:text-white">Appointments</span>
                </Link>
              </li>
              <li>
                <Link href="/medical-records">
                  <span className="text-emerald-100 hover:text-white">Medical Records</span>
                </Link>
              </li>
            </ul>
          </div>
          <div>
            ...
            <p className="text-emerald-100">Email: support@medsync.com</p>
