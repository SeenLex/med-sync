...
const NewAppointment = ({ userInfo }: { userInfo: UserInfo }) => {
  ...
  const { data: appointments, isLoading: appointmentsLoading } = useQuery({
    ...
    queryFn: () =>
      fetchDoctorAppointmentsForDate(selectedDoctor!.id, selectedDate!),
  ...
  function handleSubmit() {
    ...
    newEndDate.setMinutes(newStartDate.getMinutes() + 30); // Assuming appointments are 30 minutes long
