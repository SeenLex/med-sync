    ...
    <div className="p-6 space-y-12">
      ...
      <div className="bg-white shadow rounded-lg p-6 space-y-4">
        <div className="flex flex-wrap justify-between items-center gap-4">
          ...
          <div className="relative w-1/3">
            ...
            <input
              ...
              className="block w-full pl-10 pr-4 py-2 rounded-md text-gray-700"
              value={searchQuery}
        ...
        <div className="overflow-y-auto max-h-[400px]">
          <div className="sticky top-0 bg-gray-50 grid grid-cols-4 gap-4 px-6 py-3">
            ...
            <div className="text-xs font-medium text-gray-500 uppercase text-right">
              Actions
            </div>
          </div>
          ...
          {filtered.length > 0 ? (
            filtered.map((u) => (
              <div
                key={u.id}
                className="grid grid-cols-4 gap-4 px-6 py-4 items-center hover:bg-gray-50"
              >
              ...
              <label className="block text-sm font-medium text-gray-700">
                ...
                <input
                  ...
                  className="mt-1 block w-full border border-gray-300 rounded-md
                             p-2 focus:outline-none focus:ring-2 focus:ring-emerald-500"
